...
TEST_F(FieldProxyTest, FieldPresenceCheck) {
    ...
    using WithBandwidth = typed::ContextPacketBuilder<NoTimestamp, NoClassId, bandwidth>;
    ...
    using WithoutBandwidth =
        typed::ContextPacketBuilder<NoTimestamp, NoClassId,
                                    sample_rate>; // Has sample_rate, NOT bandwidth
...
TEST_F(FieldProxyTest, DifferentFieldSizes) {
    using TestContext =
        typed::ContextPacketBuilder<NoTimestamp, NoClassId, bandwidth, sample_rate, gain>;
...
TEST_F(FieldProxyTest, ConditionalPatternCompatibility) {
    using TestContext = typed::ContextPacketBuilder<NoTimestamp, NoClassId, gain>;
